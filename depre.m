...
% Last Modified by GUIDE v2.5 19-Feb-2020 05:39:04
...
contadorPrincipal=1;
dato=load('507_Depression_REST.mat');
data=[];
...
P1peakFreqs_2 = t_3(lc2);
    ...
    if((P1peakFreqs_2>=1) && ((P1peakFreqs_2<4)))
...
P1peakFreqs_2 = t_3(lc2);
   ...
   frequency_2='theta';
    ...
    canal_1=q(val);
    set(handles.text6,'string',canal_1); 
    canal_2=q(val2);
     set(handles.text7,'string',canal_2);
